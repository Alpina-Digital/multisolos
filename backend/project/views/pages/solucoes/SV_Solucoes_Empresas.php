...
/**
 * Classe responsável pela página de Soluções para Empresas.
 * @author Alpina Digital
 * @package Alpina V4
 * @version 4.0
 */
class SV_Solucoes_Empresas extends Alp_Page
{
  use
    SV_Banner_Topo,
    SV_Apresentacao,
  ...
  {
    $this->template = new Alp_Page_Template('template-solucoes-empresas.php', 'empresas');
 ...
 * Hooks
 */
add_action('after_setup_theme', [new SV_Solucoes_Empresas(), 'setup']);
