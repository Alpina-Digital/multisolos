...
/**
 * Classe responsável pela página de Soluções para Agronegócio.
 * @author Alpina Digital
 * @package Alpina V4
 * @version 4.0
 */
class SV_Solucoes_Agronegocio extends Alp_Page
{
  use
    SV_Banner_Topo,
    SV_Apresentacao,
  ...
  {
    $this->template = new Alp_Page_Template('template-solucoes-agronegocio.php', 'agronegocio');
 ...
 * Hooks
 */
add_action('after_setup_theme', [new SV_Solucoes_Agronegocio(), 'setup']);
