...
<div class="overflow-hidden">
  <section class="section-nossos-projetos max-width-lg container flex flex-column gap-lg">
    ...
    <div class="grid gap-sm">
      ...
      <div class="col-12 col-3@sm flex flex-column gap-sm justify-between">
        <?= $card_ponta; ?>
        <div class="section-nossos-projetos__ver-todos hide flex@md justify-start items-center">
          <a href="<?= $link_projetos; ?>" class="btn btn--accent btn--hover-white">Ver todos</a>
        </div>
      </div>
    </div>
