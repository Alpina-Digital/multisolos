...
/**
 * Template Part Name: Etapa Serviço V2
...
extract($args);
?>
<li class="item-etapa-servico-v2 accordion__item <?= $numero == 1 ? 'accordion__item--is-open' : ''; ?> js-accordion__item">
  <button class="reset accordion__header padding-y-sm js-tab-focus color-white" type="button">
    <div class="flex gap-xs items-center">
      <span class="item-etapa-servico-v2__numero"><?= $numero ?? ''; ?></span>
      <span class="item-etapa-servico-v2__titulo"><?= $titulo ?? ''; ?></span>
    </div>
  ...
  <div class="accordion__panel padding-bottom-sm js-accordion__panel">
    <div class="item-etapa-servico-v2__texto text-component">
