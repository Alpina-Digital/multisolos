...
/**
 * Template Part Name: Etapas Serviço
...
extract($args);
?>
<section class="section-etapas-servico bg-cinza-escuro-ultra <?= $classes; ?>">
  <div class="max-width-lg container grid gap-xl gap-xxl@md">
    ...
    <div class="col-12 col-4@md flex flex-column gap-xl items-start">
      <div class="flex flex-column gap-sm">
        <h3 class="section-etapas-servico__subtitulo subtitulo-secao"><?= $subtitulo ?? ''; ?></h3>
        <h2 class="section-etapas-servico__titulo titulo-secao"><?= $titulo ?? ''; ?></h2>
      </div>
